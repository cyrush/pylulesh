...
def SumElemFaceNormal(normalX0, normalY0, normalZ0,
...
#            sigxx, sigyy, sigzz ):
    ...
    x_local = alloc_ndarray([8,1],np.float64)
    y_local = alloc_ndarray([8,1],np.float64)
    z_local = alloc_ndarray([8,1],np.float64)
    fx_local = alloc_ndarray([8,1],np.float64)
    fy_local = alloc_ndarray([8,1],np.float64)
    fz_local = alloc_ndarray([8,1],np.float64)
